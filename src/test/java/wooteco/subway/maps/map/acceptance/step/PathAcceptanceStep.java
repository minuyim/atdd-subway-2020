...
public class PathAcceptanceStep {
    ...
    public static ExtractableResponse<Response> 로그인_후_거리_경로_조회_요청(String type, long source, long target, TokenResponse tokenResponse) {
        return RestAssured.given().log().all().
    ...
    public static void 총_거리와_소요_시간을_요금과_함께_응답함(ExtractableResponse<Response> response, int totalDistance,
