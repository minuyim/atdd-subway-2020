...
public class TestObjectUtils {
    ...
    public static Line createLine(Long id, String name, String color, int extarFare) {
        Line line1 = new Line(name, color, extarFare, LocalTime.of(05, 30), LocalTime.of(23, 30), 10);
        ReflectionTestUtils.setField(line1, "id", id);
        return line1;
    }
}
